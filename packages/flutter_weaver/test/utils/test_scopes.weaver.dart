...
extension Test1ScopeOnWeaverAddedToWeaver on Weaver {
  Test1ScopeOnWeaver get test1Scope => Test1ScopeOnWeaver(ScopeHandlerWeaverProxy(this));
}
...
extension Test2ScopeOnWeaverAddedToWeaver on Weaver {
  Test2ScopeOnWeaver get test2Scope => Test2ScopeOnWeaver(ScopeHandlerWeaverProxy(this));
}

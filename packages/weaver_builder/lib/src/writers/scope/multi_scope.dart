...
void writeClassesForMultiScope({required StringBuffer buffer, required LibraryElement2 library}) {
...
//       buffer.writeln(
//         '''
//       class $scopeClassName extends Scope<$scopeArgsClassName> {
//         static const String scopeName = '$scopeName';

//         $scopeClassName($constructorArguments):super(name: "$scopeName", args: $argsValue);
//       }
//       ''',
//       );
...
//           // constructor
//           $scopeArgsClassName(
//             ${scopeClassArgs.map((arg) => 'this.${arg.displayName},')}
//           );
